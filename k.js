...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/ShellUI/favicon.ico">
    <script>

        window.FeatureFlags = [
            "US1312538_DownloadCleanup",
            "F244324_TicketSystem_SSO",
            "CLNTSVC_16687_EnableInviewAPI",
            "F285297_EntityAdminRedesign",
            "CLNTSVC_25258_HideProfileTab",
            "CLNTSVC_25740_DownloadLogs",
            "CLNTSVC_26311_BulletinIDFilter",
            "CLNTSVC_25640_BCUOptAllProducts",
            "CLNTSVC_30054_Failure_LoginLog",
            "CLNTSVC_28018_SubList_Audit",
            "CLNTSVC_30155_TimeZoneDateFormatting",
            "CLNTSVC_30158_AssociateEvent_TZ",
            "CLNTSVC_30164_Enable_TimeZoneDateFormatting",
            "CLNTSVC_30167_Enable_TimeZoneDateFormatting_ForReportRule",
            "CLNTSVC_30168_ComplianceReport_TZ",
            "CLNTSVC_30170_EditCompliance_TZ",
            "CLNTSVC_26770_AuditLogUserOnBoard",
            "CLNTSVC_28545_Validate_Email_Before_Username",
            "CLNTSVC_30121_Enable_TimeZoneDateFormatting",
            "CLNTSVC_29920_EntityID_Validation",
            "CLNTSVC_30176_EMSEntityIDIncluded",
            "CLNTSVC_29198_CreateReportAdmin",
            "CLNTSVC_29113_UserGroupInternal",
            "CLNTSVC_24360_SolutionField",
            "CLNTSVC_30262_FirstLastNameInDownloadedFile",
            "CLNTSVC_30157_Enable_TimeZoneDateFormatting",
            "CLNTSVC_30133_Enable_TimeZoneDateFormatting",
            "CLNTSVC_30135_Enable_TimeZoneDateFormatting",
            "CLNTSVC_30136_Enable_TimeZoneDateFormatting_ForUserOnboarding",
            "CLNTSVC_31097_MyProducts_Strategy_DateSortNewestToOldest",
            "CLNTSVC_31106_Myproducts_Documentation_DateSortNewestToOldest",
            "CLNTSVC_31115_Myproducts_Services_DateSortNewestToOldest",
            "CLNTSVC_31124_MyProducts_Training_DateSortNewestToOldest",
            "CLNTSVC_31142_Bulletins_DateSort",
            "CLNTSVC_31160_Reports_DateSortNewestToOldest",
            "CLNTSVC_31232_Username_After_Last_Updated_By",
            "CLNTSVC_31169_UserOnBoarding_DateSort",
            "CLNTSVC_31196_SoftwareDownloadLogs_DateSort",
            "CLNTSVC_31295_WarningExpiration",
            "CLNTSVC_30139_Kordoba_SearchUserInIDP",
            "CLNTSVC_31511_ContactUs_RemovePagerField",
            "CLNTSVC_32037_LEFT_Navigation",
            "CLNTSVC_31269_Session_Expiry_Popup",
            "CLNTSVC_34510_Bulletins_Export_FilterFix",
            "CLNTSVC_35159_AddGuidinLegacyTables",
            "CLNTSVC_32965_LoginLog"
        ];
        var ssoFirmName='';
        var sessionSecond = 0; // Simplified from redundant parseInt
        var popUpShownSecond = 300; 
        var sessionCheckSecond = -1140; 

        var keepSessionAliveUrl = "/api/sitecore/Account/KeepSessionReminderAlive";
        var CheckSessionAliveUrl = "/api/sitecore/Account/GetOrResetLastAccessServerTime";
        var IdpImageURL = '/csa/images/spacer.gif';
    </script>

    
    <script src="/Assets/Extranet/scripts/sanitizerscripts?v=HU590Bvg-40zYmguAS-BL7HvXp-D3lKfyeiC-kUHSLI1"></script>

    <script src="/Assets/Extranet/scripts/DOMPurifyscripts?v=wdVMN8zfAwHlxBVXIk7BVaU-7skrkjWYE8piyYJtpD81"></script>

    <script src="/Assets/Extranet/scripts/RufHeaderScripts?v=vQBaPDVq4oDZEpPCE208BNXxh5GszJHy3mxT3Ra2Bg01"></script>


    <script>
        var _rootUrl = "https://my.fisglobal.com/";
        var tokenExpired = 'N';
    </script>
    ...
    <script type="text/javascript">
        ...
        async function AuthEvent() {
            console.log("AuthEvent Method called");
            try {
                const response = await fetch(_rootUrl + '_extranet/Account/GetRefreshJWTToken', {
                    method: 'GET',
                    headers: {
                ...
                if (data && data.Token) {
                    Inq.fireCustomEvent("sendNewToken", { "token": data.Token });
                }
            } catch (error) {
                console.error("New Token from CP for CB failed:", error);
            }
        }
    ...
    <link rel="stylesheet" href="/ShellUI/styles.css">
    <link href="/ShellUI/iconstyles.css" rel="stylesheet" />
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-W2TDPVJ');
    </script>
...
<body>
    ...
    <!--logsentryerror method we are using to log error in sentry, when image load fail
        we can also add the sentry error log in logoutuser method-->
    

    <!-- checkmarx CSRF issue (antiforgery token created to fetch from angular HttpConfigInterceptor) -->

    <div id="__RequestVerificationTokenApi">
        <input type="hidden" value="QNNF1_Xbmz5PRmkwN-5IKKOj-oqu5LwBDkL31x7zi46BTXLqLfWU9fGCFYrLtnXSmJSVqmsHhe35qcCrCzJTEg2:JsxiNK8-v2_-BTLKb9n15XUDHCV4dMQQFqNdXhGByBf6ljcuky3ljPAuG9T3_uGYp2L39ihepCCj1_QACiNxGQ2" />
    </div>


    
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W2TDPVJ"
                height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
    <!-- End Google Tag Manager (noscript) -->

    <client-portal-root otherData='{"IsEbt":"OTHER","IsEBTv1":"","IsInternalUser":"","isEmulatedEntityCAEBT":"false",
                        "LOGOUT_Title":"Please Note",
                        "LOGOUT_TEXT_MESSAGE":"Are you sure you want to logout?",
                        "IDPSESSION_LOGOUT_TEXT_MESSAGE":"Your SSO session has ended.  Please try logging back in to open a new session."}'
                        footerData='{"Copyright":"&amp;#169; 2026 FIS. Advancing the way the world pays, banks and invests","Url":"http://fisglobal.com","Target":"_blank","Text":"FISGlobal.com"}' sessionPopUpData='{
                        "PopUpTitle":"Attention",
                        "ReminderChoice":"Do you need more time?",
                        "ReminderMessage":"You&#39;re about to be logged out due to inactivity",
                        "BtnLogout":"LOG OUT",
                        "BtnStayLoggedIn":"STAY LOGGED IN"
                        }'><ruf-loading-screen></ruf-loading-screen></client-portal-root>
    ...
    <script src="/Assets/Extranet/scripts/RufBodyScripts" defer></script>
    ...
    <script type="text/javascript">
        ...
        //function showSessionTimeout(isShow) {
        //    window.angularComponentReference.zone.run(() => { window.angularComponentReference.openSessionDialog(isShow); });
        //}
        //function logOutUser(logParm) {
        //    if (logParm == undefined)
        //        logParm = "F5";
        //    window.angularComponentReference.zone.run(() => { window.angularComponentReference.logout(); });
        //}
        //function onLoadidpImage() {
        //    window.angularComponentReference.zone.run(() => { window.angularComponentReference.loadidpImage(); });
        //}

        // Code commented against the jira story CLNTSVC-34171
        //function logSentryError(logParm) {
        //    if (logParm == undefined)
        //        logParm = "F5";
        //    window.angularComponentReference.zone.run(() => { window.angularComponentReference.logError(); });
        //}
        function showLoader() {
            window.angularComponentReference.zone.run(() => { window.angularComponentReference.showLoader(); });
        }
        function loadCasrRoles() {
            if (window.location.href.indexOf("idpuserpermission") <= -1)
                window.angularComponentReference.zone.run(() => { window.angularComponentReference.loadCasrRoles(); });
        }
        function BodyClicked() {
            window.angularComponentReference.zone.run(() => { window.angularComponentReference.iframeClicked(); });
        }
        function AdjustModal(isShow) {
            window.angularComponentReference.zone.run(() => { window.angularComponentReference.AdjustModal(isShow); });
        }
    </script>
    ...
    <svg aria-hidden="true" style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
            ...
            <symbol id="fis-icon-twitter" viewBox="0 0 38 32">
                <title></title>
                <path d="M12.668 30.909c14.022 0 21.943-11.971 21.466-22.707 1.475-1.076 2.756-2.42 3.768-3.951-1.355 0.607-2.81 1.018-4.338 1.201 1.559-0.943 2.757-2.44 3.32-4.223-1.459 0.875-3.075 1.51-4.796 1.852-1.377-1.484-3.339-2.41-5.512-2.41-4.874 0-8.458 4.598-7.357 9.373-6.276-0.319-11.842-3.358-15.565-7.977-1.979 3.431-1.027 7.92 2.337 10.192-1.238-0.039-2.403-0.383-3.422-0.954-0.081 3.536 2.425 6.843 6.057 7.582-1.063 0.292-2.227 0.358-3.41 0.13 0.961 3.032 3.75 5.239 7.054 5.301-3.174 2.516-7.174 3.639-11.18 3.161 3.342 2.166 7.312 3.43 11.577 3.43z"></path>
            </symbol>
